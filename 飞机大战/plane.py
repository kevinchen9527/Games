...
class PlaneGame(object):
    ...
    def __init__(self):
        ...
        self.index = 0
        # 音乐bgm
        self.bg_music = pygame.mixer.Sound(os.path.abspath(os.path.dirname(__file__))+"/music/game_music.ogg")
    ...
    def score_show(self):
        score_font = pygame.font.Font(os.path.abspath(os.path.dirname(__file__)) + "/STCAIYUN.ttf", 33)
