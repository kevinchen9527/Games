...
class Background(GameSprite):
    ...
    def __init__(self, is_alt=False):
        ...
        super().__init__(os.path.abspath(os.path.dirname(__file__)) + "/images/background.png")
...
class Boss(GameSprite):
    ...
    def __init__(self):
        super().__init__(os.path.abspath(os.path.dirname(__file__)) + "/images/enemy3_n1.png", 0, 1)
        self.music_boom = pygame.mixer.Sound(os.path.abspath(os.path.dirname(__file__)) + "/music/enemy3_down.wav")
        self.music_fly = pygame.mixer.Sound(os.path.abspath(os.path.dirname(__file__)) + "/music/enemy3_flying.wav")
    ...
    def update(self):
        ...
        # 发电动画
        self.image = pygame.image.load(os.path.abspath(os.path.dirname(__file__)) + "/images/enemy3_n" + str((self.index1 // 6) % 2 + 1) + ".png")
        self.index1 += 1
        ...
        if self.isboom:
            ...
            if self.bar.length <= 0:  # 此时满足爆炸的条件了
                ...
                if self.index2 < 29:  # 4*7+1
                    self.image = pygame.image.load(os.path.abspath(os.path.dirname(__file__)) + "/images/enemy3_down" + str(self.index2 // 7) + ".png")
...
class Enemy(GameSprite):
    ...
    def __init__(self, num=1):
        ...
        super().__init__(os.path.abspath(os.path.dirname(__file__)) + "/images/enemy" + str(num) + ".png")

        # music
        if num == 1:
            self.music_boom = pygame.mixer.Sound(os.path.abspath(os.path.dirname(__file__)) + "/music/enemy1_down.wav")
        else:
            self.music_boom = pygame.mixer.Sound(os.path.abspath(os.path.dirname(__file__)) + "/music/enemy2_down.wav")
        # 2. 指定敌机的初始随机速度 1 ~ 3
        ...
        if self.isboom:
            ...
            if self.bar.length <= 0:
                ...
                if self.index < 17:  # 4*4+1
                    self.image = pygame.image.load(os.path.abspath(os.path.dirname(__file__)) + 
...
class Hero(GameSprite):
    ...
    def __init__(self):
        ...
        super().__init__(os.path.abspath(os.path.dirname(__file__)) + "/images/me1.png")
        self.music_down = pygame.mixer.Sound(os.path.abspath(os.path.dirname(__file__)) + "/music/me_down.wav")
        self.music_upgrade = pygame.mixer.Sound(os.path.abspath(os.path.dirname(__file__)) + "/music/upgrade.wav")
        self.music_degrade = pygame.mixer.Sound(os.path.abspath(os.path.dirname(__file__)) + "/music/supply.wav")
    ...
    def update(self):
        ...
        self.image = pygame.image.load(os.path.abspath(os.path.dirname(__file__)) + "/images/me" + str((self.index1 // 6) % 2 + 1) + ".png")
        self.index1 += 1
        ...
        if self.isboom:
            ...
            if self.bar.length <= 0:  # 此时满足爆炸的条件了
                ...
                if self.index2 < 17:  # 4*4+1
                    self.image = pygame.image.load(os.path.abspath(os.path.dirname(__file__)) + "/images/me_destroy_" + str(self.index2 // 4) + ".png")
                    # 这个地方之所以要整除4是为了减慢爆炸的速度，如果按照update的频率60hz就太快了
                    self.index2 += 1
                else:
                    self.kill()
...
class Heromate(Hero):
    def __init__(self, num):
        super().__init__()
        self.image = pygame.image.load(os.path.abspath(os.path.dirname(__file__)) + "/images/life.png")
        self.number = num
...
class Bullet(GameSprite):
    ...
    def __init__(self, color=1, speedy=-2, speedx=0):
        ...
        self.music_shoot = pygame.mixer.Sound(os.path.abspath(os.path.dirname(__file__)) + "/music/bullet.wav")
        self.music_shoot.set_volume(0.4)
        if color > 0:  # 只让英雄发子弹响
            self.music_shoot.play()
        super().__init__(os.path.abspath(os.path.dirname(__file__)) + "/images/bullet" + str(color) + ".png", speedy, speedx)
...
class Buff1(GameSprite):
    def __init__(self):
        super().__init__(os.path.abspath(os.path.dirname(__file__)) + "/images/bullet_supply.png", 1)
        self.music_get = pygame.mixer.Sound(os.path.abspath(os.path.dirname(__file__)) + "/music/get_bullet.wav")
        self.rect.bottom = 0
        max_x = SCREEN_RECT.width - self.rect.width
        self.rect.x = random.randint(0, max_x)
...
class Buff2(GameSprite):
    def __init__(self):
        super().__init__(os.path.abspath(os.path.dirname(__file__)) + "/images/bomb_supply.png", 2)
        self.music_get = pygame.mixer.Sound(os.path.abspath(os.path.dirname(__file__)) + "/music/get_bomb.wav")
...
class Buff3(Buff2):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(os.path.abspath(os.path.dirname(__file__)) + "/images/buff3.png")
        self.speedy = 3
...
class CanvasOver():
    def __init__(self, screen):
        self.img_again = pygame.image.load(os.path.abspath(os.path.dirname(__file__)) + "/images/again.png")
        self.img_over = pygame.image.load(os.path.abspath(os.path.dirname(__file__)) + "/images/gameover.png")
    ...
    def update(self):
        ...
        score_font = pygame.font.Font(os.path.abspath(os.path.dirname(__file__)) + "/STCAIYUN.ttf", 50)
